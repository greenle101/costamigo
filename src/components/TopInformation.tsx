...
export default function TopInformation({ items = [] }: TopInformationProps) {
  ...
  return (
    <main className="my-2 top-posts slider-top-information w-full min-w-0 max-w-full overflow-x-hidden">
      <div className="space-y-3 md:space-y-5">
        <header className="text-center">
          <div className="top-images-logo mb-2 flex w-full min-w-0 max-w-full items-center justify-center gap-3 px-2 sm:gap-5 md:gap-8 md:px-0">
            <img
